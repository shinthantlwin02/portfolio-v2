    ...
    (<Link
      ...
      <div
        ...
        <div
          ...
          className="absolute bg-transparent left-1/2 top-1/2  flex justify-start items-start  rounded-2xl  shadow-[0_8px_16px_rgba(63,108,165,1)] border-2 border-[#3F6CA5] group-hover/pin:border-[#3F6CA5] transition duration-700 overflow-hidden">
      ...
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <a
            href={href}
            target={"_blank"}
            className="relative flex space-x-2 items-center z-10 rounded-full bg-transparent py-0.5 px-4 ring-1 ring-[#3F6CA5] ">
            <span
